...
function yourpropfirm_connection_sandbox_test_key_callback() {
    ...
    echo '<input type="password" name="yourpropfirm_connection_sandbox_test_key" value="' . esc_attr($option) . '" style="width: 400px;">';
}
...
function yourpropfirm_connection_api_key_callback() {
    ...
    echo '<input type="password" name="yourpropfirm_connection_api_key" value="' . esc_attr($option) . '" style="width: 400px;">';
}
